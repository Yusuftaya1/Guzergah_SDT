...
class MotorController(Node):
    def __init__(self):
        ...
        self.coef = 0.02
        self.qr_id = None  # QR kodu değeri
        ...
        self.qr_status_sub = self.create_subscription(
            String,
            '/qr_code_data',
            self.qr_callback,
            10
    ...
    def angle_callback(self, msg):
        ...
        if self.qr_id == "1":
            ...
            self.motor_values_msg.linear_actuator = 500.0
        
        elif self.qr_id == "2":
            self.motor_values_msg.sag_teker_hiz = 0.0
            self.motor_values_msg.sol_teker_hiz = 0.0
            self.motor_values_msg.linear_actuator = 0.0
