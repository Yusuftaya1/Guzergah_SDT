...
static const _SensorValues_type_support_symbol_names_t _SensorValues_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdt_project, msg, SensorValues)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sdt_project, msg, SensorValues)),
  }
};
...
{
  return &::sdt_project::msg::rosidl_typesupport_cpp::SensorValues_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sdt_project, msg, SensorValues)() {
  return get_message_type_support_handle<sdt_project::msg::SensorValues>();
}
